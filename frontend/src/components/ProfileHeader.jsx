    ...
    <div className='p-6 border-b border-slate-700/50'>
        <div className="flex items-center justify-between">
            ...
            <div className="flex gap-4 items-center">
                {/* logout button */}
                <button onClick={logout} className='p-2 rounded-md hover:bg-slate-700/50 transition-colors'>
                ...
                { isSoundEnabled ? <Volume2Icon className='size-5 text-slate-400' /> : <VolumeOffIcon className='size-5 text-slate-400' /> }
                </button>
            </div>
        </div>
    </div>
